        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--bg-surface)] p-8 shadow-xl">
            <div>
              ...
              <div className="pt-3 text-3xl font-bold text-[var(--text-primary)]">Order medicines</div>
              <div className="pt-2 text-[var(--text-secondary)]">
                Browse available stock, add items to your cart, and place an order for delivery.
              </div>
            </div>
